  ...
  return (
    <div className="flex flex-col items-center justify-center py-16 text-center">
      ...
      <p className="mt-2 max-w-sm text-body-sm leading-relaxed text-muted-foreground">
        Enter one or more URLs in the form above to extract clean, structured
      ...
      <div className="mt-6 flex flex-wrap items-center justify-center gap-3">
        <div className="flex items-center gap-2 rounded-lg bg-surface-1 px-3 py-2">
          ...
          <span className="text-xs text-muted-foreground">Multiple URLs</span>
        </div>
        <div className="flex items-center gap-2 rounded-lg bg-surface-1 px-3 py-2">
          <FileText className="h-3.5 w-3.5 text-primary" />
          <span className="text-xs text-muted-foreground">Clean text</span>
        </div>
      </div>
    </div>
  )
